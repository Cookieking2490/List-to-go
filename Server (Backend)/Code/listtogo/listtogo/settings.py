"""
Django settings for listtogo project.
...
SECRET_KEY = 'django-insecure-()e_y@q*z5^r1qn@ni1cpccqk_*gvbar54+@-dg(ertfo(fb_5'
...
WSGI_APPLICATION = 'listtogo.wsgi.application'
